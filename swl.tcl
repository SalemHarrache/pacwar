...
set id_S1 [S Add_new_ship $id_P1 300 200 10]
S Update_ship $id_P1 $id_S1 [dict create fire_velocity 1 fire_angle 1]

set id_S2 [S Add_new_ship $id_P1 200 300 10]
S Update_ship $id_P1 $id_S2 [dict create fire_velocity 10 fire_angle 1]

set id_S3 [S Add_new_ship $id_P2 500 200 10]
S Update_ship $id_P2 $id_S3 [dict create fire_velocity 1 fire_angle 5]

set id_S4 [S Add_new_ship $id_P2 500 300 10]
S Update_ship $id_P2 $id_S4 [dict create fire_velocity 10 fire_angle 5]
